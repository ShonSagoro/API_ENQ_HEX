...
export class Reservation implements ValidatableEntity {
    ...
    public constructor(user_uuid: string, hotel_uuid: string, room_uuid: string, description: string, date_start: Date, date_end: Date, payment: PaymentMethod) {
        this.uuid = uuidv4();
    ...
    public setRoomUUID(room_uuid: string): void {
        this.room_uuid = room_uuid;
    }
